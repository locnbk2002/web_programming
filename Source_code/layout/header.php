    ...
    <div id="site">
        <div id="container">
            ...
            <div id="head-body" class="clearfix">
                <div class="wp-inner">
                    <a href="?modules=home" title="" id="logo" class="fl-left"><img src="public/images/logo-fastshoping.png" style="height: 60px; border-radius: 5px" /></a>
            ...
            <div id="header-wp">
                <div id="head-top" class="clearfix">
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" style="align-items: center;">
