				...
				<form method="POST" action="?modules=users&controllers=index&action=createAccount" name="form-checkout">
						...
						<div class="form-row clearfix">
							...
							<div class="form-col fl-right">
								...
								<input style="height: 38px;border: 1px solid #cccccc;" type="password" name="password" id="email" class="form-control">
							</div>
						</div>
						<div class="form-row clearfix">
							<div class="form-col fl-left">
						...
						<div class="form-row clearfix">
										<div class="form-col fl-left">
											<a href="?modules=users&action=index">Hoặc đăng nhập tài khoản tại đây</a>
										</div>
									</div>
